...
%TODO Where to put the following part? Its a introduction between clouds and IaC...
%\newline
...
In order to describe the state of infrastructure, the declarative way is more intuitive. It is the same way humans would describe a state (i.e. \textquote{I see three apples} instead of three times \textquote{I see an apple}).
\newline
