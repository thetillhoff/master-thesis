...
% Add image with in-house/on-premis infra, off-premise infra, private cloud, public cloud and hybrid cloud


- "local datacenter" is basically a private, on-premise cloud. (? ... at least nowadays)
