...
\newline
These two categories are named differently in different sources, f.e. using \textquote{Infrastructure Definition} as a synonym for provisioning and \textquote{Configuration Registry} for configuration management. Some software like Ansible can also fill both roles \cite{iac_oreilly}.
\newline
