...
The languages this thesis is going to compare are HashiCorp Configuration Language (HCL), Pulumi (Golang-SDK) and TOSCA in combination with  \textquote{Simple-Profile}.
\newline
